...
to go-geo
  ...
  ask patches
    [ ifelse (normal-neighbors >= 6 or (infect-neighbors >= 2 and infect-neighbors <= 4)) and living = 1
      [ cell-infect ]
...
to go-anjelo
  ...
  ask patches
    [ set normal-neighbors count neighbors with [living = 1] ]
  ask patches
    [ ifelse normal-neighbors >= 6 and living = 1
      [ cell-infect ]
      [ set infect-neighbors count neighbors with [living = 2] ] ]
  ask patches
    [ ifelse infect-neighbors >= 2 and living = 1
      [ cell-infect ]
  ;; infect to death
      [ set infect-neighbors count neighbors with [living = 2] ] ]
  ask patches
    [ if infect-neighbors >= 3 and living = 2
      [ cell-death ]  ]
  ;; reproduction
  ask patches
      [ set normal-neighbors count neighbors with [living = 1] ]
